...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gc', builtin.git_commits, { desc = '[G]it [C]ommits (repo log)' })
      vim.keymap.set('n', '<leader>gf', builtin.git_bcommits, { desc = '[G]it commits for current [F]ile' })
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      local capabilities = vim.tbl_deep_extend('force', vim.lsp.protocol.make_client_capabilities(), require('blink.cmp').get_lsp_capabilities({}, false))
  ...
  --     }
  --
  --     vim.keymap.set('n', '<leader>z', "<cmd>lua require('neotest').run.run()<CR>", { desc = 'Run Test' })
  --     vim.keymap.set('n', '<leader>zf', "<cmd>lua require('neotest').run.run(vim.fn.expand('%'))<CR>", { desc = 'Run Test File' })
  --     vim.keymap.set('n', '<leader>zp', "<cmd>lua require('neotest').output_panel.toggle()<CR>", { desc = 'Toggle Test Output Panel' })
  --     vim.keymap.set('n', '<leader>zl', "<cmd>lua require('neotest').run.run_last()<CR>", { desc = 'Run Last Test' })
  --     vim.keymap.set('n', '<leader>zs', "<cmd>lua require('neotest').summary.toggle()<CR>", { desc = 'Toggle Test Summary' })
  --   end,
  -- },
  { -- Autoformat
